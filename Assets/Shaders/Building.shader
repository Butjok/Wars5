Shader "Custom/Building"
{
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            half3 bounce = tex2D (_BounceLight, IN.uv2_BounceLight);
            ...
            //if (IN.worldPos.y < .1)
              //  o.Smoothness=1;
            //o.Alpha = c.a;
            o.Occlusion= tex2D (_Occlusion, IN.uv2_BounceLight);
            ...
            //o.Albedo = smoothstep((c.r + c.g + c.b) / 3, 0, .1);
        }
        ENDCG
    }
    FallBack "Diffuse"
