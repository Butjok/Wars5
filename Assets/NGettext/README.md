NGettext [![Build Status](https://travis-ci.org/VitaliiTsilnyk/NGettext.svg?branch=master)](https://travis-ci.org/VitaliiTsilnyk/NGettext) [![Build Status](https://ci.appveyor.com/api/projects/status/snyyyv6x6xolyxc4?svg=true)](https://ci.appveyor.com/project/VitaliiTsilnyk/ngettext) [![NuGet](https://img.shields.io/nuget/v/NGettext.svg?label=nuget:%20NGettext)](https://www.nuget.org/packages/NGettext/) [![NuGet](https://img.shields.io/nuget/v/NGettext.svg?label=nuget:%20NGettext.PluralCompile)](https://www.nuget.org/packages/NGettext.PluralCompile/)
========
