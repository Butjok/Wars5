...
[Serializable]
[PostProcess(typeof(VignetteBlurRenderer), PostProcessEvent.AfterStack, "Custom/VignetteBlur")]
public sealed class VignetteBlur : PostProcessEffectSettings {
...
public sealed class VignetteBlurRenderer : PostProcessEffectRenderer<VignetteBlur> {
    public const string shaderName = "Hidden/Custom/VignetteBlur";
