...
public class DefaultLevelLogic {
	...
	public virtual (ControlFlow controlFlow, IEnumerator state) OnVictory(Game2 game) {
		return (ControlFlow.Ignore, null);
	}

	public virtual (ControlFlow controlFlow, IEnumerator state) OnDefeat(Game2 game) {
		return (ControlFlow.Ignore, null);
	}
}