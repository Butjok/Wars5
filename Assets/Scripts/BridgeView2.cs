...
public class BridgeView2 : MonoBehaviour {
    ...
    public void SetPositions(List<Vector2Int> positions, Vector2Int? singleTileForward = null) {
        ...
        for (var i = 0; i < positions.Count; i++) {
            ...
            piece.meshFilter.sharedMesh = positions.Count == 1 ? meshSingle : i == 0 || isLastPiece ? meshEnd : meshTile;
            ...
            else if (singleTileForward is { } actualValue)
                piece.meshFilter.transform.rotation = Quaternion.LookRotation(actualValue.Rotate(rotationOffset).ToVector3(), Vector3.up);
