...
public sealed class CameraFading : PostProcessEffectSettings {
    ...
    public FloatParameter squareSize = new() { value = 0.5f };
    [Range(0f, 10), Tooltip("Circle smoothness.")]
    public FloatParameter smoothness = new() { value = 0.5f };
    [Range(0, 1), Tooltip("Progress.")]
    public FloatParameter progress = new() { value = 0.5f };
    [Range(0, 1), Tooltip("Progress smoothness.")]
    public FloatParameter progressSmoothness = new() { value = 0.5f };
    [Range(0, 1), Tooltip("Y contribution.")]
    public FloatParameter yContribution = new() { value = 0.5f };
    [Range(0, 1), Tooltip("Invert.")]
    public BoolParameter invert = new();
}
